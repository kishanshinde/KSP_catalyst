  ...
  return (
    ...
    >
      <div className="flex-1 flex flex-col min-w-0 h-full">
        <div className="sticky top-0 z-10 shrink-0 flex items-center justify-between px-4 py-2 border-b border-outline-variant/30 dark:border-slate-700/30 bg-white/40 dark:bg-slate-900/40 backdrop-blur-sm">
          <button
            onClick={() => navigate('/')}
